...
document.getElementById('load').addEventListener("click", loaded);

function saved() {
  document.getElementById('load-result').classList.remove('active');
  document.getElementById('save-result').classList.toggle('active'); 
}

function loaded() {
  document.getElementById('save-result').classList.remove('active');
  document.getElementById('load-result').classList.toggle('active');
}
